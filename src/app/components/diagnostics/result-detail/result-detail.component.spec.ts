...
import { ApiService, TableService, JobStateService } from 'app/services';
...
import { EventListComponent } from 'app/widgets';
...
@NgModule({
  ...
  imports: [
    SharedModule, ChartModule, CommonModule, FormsModule, ScrollingModule, VirtualScrollTableModule
  ],
  entryComponents: [

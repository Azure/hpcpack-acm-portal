...
import { VirtualScrollTableModule, TableOptionComponent, ConfirmDialogComponent, ConfirmDialogModule } from 'app/widgets';
...
@NgModule({
  ...
  entryComponents: [NewDiagnosticsComponent, NewCommandComponent, NodeGroupComponent, TableOptionComponent, ConfirmDialogComponent],

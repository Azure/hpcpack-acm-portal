...
import { ConfirmDialogComponent } from 'app/widgets/confirm-dialog/confirm-dialog.component';
import { JobStateService } from 'app/services/job-state/job-state.service';

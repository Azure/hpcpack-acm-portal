...
export class JobOverviewComponent implements OnInit, OnChanges {
  ...
  getAccessiblityInfo() {
    this.description = `Total number of ${this.jobCategory} job is ${this.totalJobs}, ${this.activeJobs} of them are active.`;
    for (let label of this.labels) {
      this.detailDescription[label] = `The number of ${label} ${this.jobCategory} job is ${this.jobs[label]}`
    }
  }
